...
fname = 'progressive_results.csv';
fname2 = 'offline_results.csv';

spkrs = [374,2843,5456,7447,7505];

data = readtable([data_path fname],'Delimiter',',');
data2 = readtable([data_path fname2],'Delimiter',',');
...
saveas(gcf,['./figures/onlinePLDA_tchange_rchange.fig']);
print(['./figures/onlinePLDA_tchange_rchange.eps'],'-depsc','-r300');    
print(['./figures/onlinePLDA_tchange_rchange.png'],'-dpng','-r300');    
end
...
fileID = fopen([store_path 'onlinePLDA_mean_hit_miss_fa.csv'],'w');
...
if 1
    ...
    saveas(gcf,['./figures/onlinePLDA_hit_miss_fa.fig']);
    print(['./figures/onlinePLDA_hit_miss_fa.eps'],'-depsc','-r300');    
end           
...
if 1
store_path = './data/results/';
fileID = fopen([store_path 'onlinePLDA_talkerwise_fa.csv'],'w');
...
if 1
    ...
    saveas(gcf,['./figures/onlinePLDA_talker_wise_fa.fig']);
    print(['./figures/onlinePLDA_talker_wise_fa.eps'],'-depsc','-r300');    
end           
