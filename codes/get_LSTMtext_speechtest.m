...
data_path = './data/LSTM/output/';
fname = 'LSTM_text_output.csv';
...
saveas(gcf,['./figures/textLSTM_tchange_rchange.fig']);
print(['./figures/textLSTM_tchange_rchange.eps'],'-depsc','-r300');    
print(['./figures/textLSTM_tchange_rchange.png'],'-dpng','-r300');    
end
...
fileID = fopen([store_path 'textLSTM_mean_hit_miss_fa.csv'],'w');
...
if 1
    ...
    saveas(gcf,['./figures/textLSTM_hit_miss_fa.fig']);
    print(['./figures/textLSTM_hit_miss_fa.eps'],'-depsc','-r300');    
end           
...
if 1
store_path = './data/results/';
fileID = fopen([store_path 'textLSTM_talkerwise_fa.csv'],'w');
...
if 1
    ...
    saveas(gcf,['./figures/textLSTM_talker_wise_fa.fig']);
    print(['./figures/textLSTM_talker_wise_fa.eps'],'-depsc','-r300');    
end           
